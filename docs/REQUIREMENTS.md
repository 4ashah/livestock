...
| REQ-LV-002 | LivestockType enum: `Ah` = Aves (poultry), `Su` = Swine (pigs), `Sa` = Sheep, `Ad` = Adult bovine, `Sd` = Young bovine (calves). System shall display localized labels; database stores the 2-letter code as char(2). | MUST |
